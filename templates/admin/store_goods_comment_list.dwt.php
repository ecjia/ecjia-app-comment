...
<div class="nav-heading">
	...
	<div class="store-total-comments">共<a href="javascript:;" style="text-decoration:none;">&nbsp;&nbsp;{if $comment_list.filter.current_count}{$comment_list.filter.current_count}{else}{$total_count}{/if}&nbsp;&nbsp;</a>条相关评论</div>
</div>
